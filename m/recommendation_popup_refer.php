...
ob_start();
session_start();
$sql_count = "SELECT td.deal_id,td.title,td.discounted_price,td.discount,td.savings,img.file FROM ".TABLE_DEALS." td LEFT JOIN ".TABLE_DEAL_IMAGES." img on td.deal_id=img.deal_id";
...
<div style="display: none;">
		...
		<div  id="refer<?php echo $i; ?>" style="width:701px;height:px;overflow:auto; background-color: transparent;">
			<?php //if (isset($_SESSION['user_id'])) { ?>
				...
				<p>Recommend now to your friends<?php //echo $curent_recom_deal_id;?></p>
				</div>
				<div class="clear"></div>
