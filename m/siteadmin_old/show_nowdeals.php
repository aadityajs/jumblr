...
?>
    	...
    	<tr>
            ...
            <td><?php if(!empty($row_deals['title'])){echo $row_deals['title'];}else{echo $row_deals['title2'];}?></td>
            <td><?php if($row_deals['status']=='1'){echo "active";}elseif($row_deals['status']=='2'){echo "Upcoming";}else{echo "Closed";}?></td>
            <td>$<?php echo stripslashes($row_deals['full_price']);?></td>
            <td><?php echo stripslashes($row_deals['deal_start_time']);?> - <?php echo stripslashes($row_deals['deal_end_time']);?></td>

            <td><a href="add_nowdeal.php?mode=edit&id=<?php echo $row_deals[deal_id];?>"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="add_nowdeal.php?mode=delete&id=<?php echo $row_deals[deal_id];?>" class="ask"><img src="images/trash.png" alt="" title="" border="0" onClick='return confirm("Are you sure to delete this deal?")' /></a></td>
			<td><a href="show_nowdeals_item.php?id=<?php echo $row_deals[deal_id];?>">View Items</a></td>
        </tr>
