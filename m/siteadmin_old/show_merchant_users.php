...
?>
    	...
    	<tr>
			...
			<a href="#" class="ask" title='Send Userid And Password to merchant' onclick="sendemail(<?php echo $row_deals[user_id];?>);"><img src="images/email.png" alt="" title="" border="0" title='Send Userid And Password to merchant' /></a>
			</td>
        </tr>
