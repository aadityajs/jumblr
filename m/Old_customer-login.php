...
<h6 style="margin:0; background:#fff; padding:0px;" >Register Now</h6>
         ...
         <td>
          ...
          <td><select name="title" class="selectbg">
            ...
            <tr>
              ...
              <input type="text" name="email" id="email" onblur="return ajaxReq(this.value); " value="<?php if(isset($_POST) && $flag==1){ echo $_POST["email"];} ?>" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
            </tr>
            <tr><td><img src="images/spacer.gif" alt="" width="1" height="13"/></td></tr>
            <tr>
            ...
            <div id='cust_register_year_errorloc' class="error"></div>
                ...
                <tr>
                  ...
                  <td width="27%"><select name="month" id="month" class="selectbg">
