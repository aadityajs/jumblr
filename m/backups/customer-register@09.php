...
?>
  ...
  <form name="cust_register" id="cust_register" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"  style="background:#fff; margin:0px; padding:0px; border:1px solid #fff;">
  ...
  <td><select name="title" class="selectbg">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
      ...
      <tr>
        ...
        <input type="text" name="fname" id="fname" value="<?php if(isset($_POST) && $flag ==1){ echo $_POST["fname"];} ?>" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/>
        </td>
      </tr>
      ...
      <tr>
        ...
        <input type="text" name="lname" id="lname" value="<?php if(isset($_POST) && $flag ==1){ echo $_POST["lname"];} ?>" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/>
        </td>
      </tr>
       <tr><td><img src="images/spacer.gif" alt="" width="1" height="13"/></td></tr>
       <!--
    ...
    <tr>
      ...
      <input type="text" name="email" id="email" onblur="return ajaxReq(this.value); " value="<?php if(isset($_POST) && $flag==1){ echo $_POST["email"];} ?>" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/>
      </td>
    </tr>
    <tr><td><img src="images/spacer.gif" alt="" width="1" height="13"/></td></tr>
    <tr>
    ...
    <tr>
      ...
      <input type="text" name="confemail" id="confemail" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["confemail"];} ?>" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/>
      </td>
    </tr>
    <tr><td><img src="images/spacer.gif" alt="" width="1" height="13"/></td></tr>
    <tr>
          ...
          <td colspan="3">
		    <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="77%"><a href="javascript: showDetails(10)" onMouseOver="return overlib('&lt;font class=bodytext&gt;<div class=white-container style=width:300px; text-align:left; margin:80px auto;><ul><li><strong>Why should i provide my birthday?</strong> <br /> <br />Users are required to provide their date of birth to encourage authenticity. You must confirm that you are at least the age of 18 years old.</li></ul><div class=white-tl></div><div class=white-bl></div><div class=white-tr></div><div class=white-br></div></div>&lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question.png" align="default" vspace="4" ></a>          	</td>
            </tr>
            </table>
			<div id='cust_register_day_errorloc' class="error"></div>
            <div id='cust_register_month_errorloc' class="error"></div>
            <div id='cust_register_year_errorloc' class="error"></div>
			</td>
        </tr>
		<tr>
          <td colspan="3">
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <input type="password" name="password" id="password" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/>
          </td>
        </tr>
         <tr><td><img src="images/spacer.gif" alt="" width="1" height="13"/></td></tr>
        <tr>
        ...
        <tr>
          ...
          <input type="password" name="cpassword" id="cpassword" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/>
          </td>
        </tr>
      </table></td>
    </tr>
      ...
      <td class="privacy_policy">By registering you agree to the  <a href="#" style="color:#3d35ac;">Terms and Conditions</a></span> and  <a href="#" style="color:#3d35ac;">Privacy Policy</a></td>
        ...
        <!--  <tr>
          ...
          <tr>
            ...
            <td align="left" valign="top"><input type="submit" name="btnRegister" value="Sign up" class="reset_btn2"  style="cursor:pointer;"/></td>
          </tr>
          <tr>
            <td align="left" valign="top">&nbsp;</td>
            <td align="left" valign="top">&nbsp;</td>
...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("cust_register");
   ...
   /* if (document.getElementById('day').value == 000) {
    	frmvalidator.addValidation("day","dontselect=000","You must confirm your age1");
    }
    if (document.getElemntById('month').value == '000') {
		frmvalidator.addValidation("month","dontselect=000","You must confirm your age2");
    } 
    if (document.getElemntById('year').value == 000) {
    	frmvalidator.addValidation("year","dontselect=000","You must confirm your age3");
    }*/
	
    frmvalidator.addValidation("year","dontselect=000","You must confirm your age");
    
    frmvalidator.addValidation("password","req","Enter your password (minimum 6 charecters)");
		 ...
		 <tr>
           ...
           <tr>
             <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td style="margin-bottom:-14px;" width="51%">Email Address </td>
                 <td style="margin-bottom:-14px;" width="49%">Password</td>
               </tr>
               <tr>
                 <td>
                 <div id='cust_login_lemail_errorloc' class="error"></div>
                 
                 <input type="text" name="lemail" id="lemail" onblur="javascript: return validateEmail(this.value);" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["email"];} ?>"class="text_box1" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
                 <td>
           ...
           <tr>
             <td colspan="3" class="forgot_password"><a href="<?php echo SITE_URL; ?>forgetpassword.php" style=" font-size:8.5pt; font-weight:normal; font-family:"Times New Roman", Arial, Helvetica, sans-serif;>Forgot your password?</a> </td>
           </tr>
         </table>
...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("cust_login");
    ...
    frmvalidator.addValidation("lemail","email","Invalid email address");
