	...
	if($flag == 0)
		...
		if($flag == 0) {
			...
			if($count_reset_select >0)
			{
				...
				$EmailTemplate = '
					<table border="0" cellspacing="0" cellpadding="0" width="620" bgcolor="#000" style="vertical-align:top; width:620px;margin:0 auto; border: 1px solid #e3e3e3; ">
					<tr>
					...
					As always, if you have any questions, comments, or concerns, please contact your <a href="#" style="text-decoration:none;">customer service</a>.<br />
					...
					<tr>
					<td style="vertical-align:top; color:#333231; font-family: Arial, Helvetica, sans-serif; line-height:26px; font-size:12px;  padding:0 0 0 0;">London, Brimingham, Glasgow, Dublin, Liverpool, Leeds, Edinburg, <a href="#" style="text-decoration:none;">more cities &raquo;</a></td>
					...
					© Geelaza.com  | Terms & Conditions    | Join us | About GeeLaza | Get Featured                                      
					</td>
					</tr>
					<tr>
...
if($flag == 2) {
?>
	<p class="reset" style="padding: 15px;">Please check your email address for a password reset link. We recommend that you check your email inbox and your junk mail folder.</p>
...
<table width="600" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
    <td width="301" height="26">Enter your Email address, click the "Submit" button and we'll send you an email with a link to reset your password.</td>
    <td width="285">
    	<?php
		if($flag == 1)
		{
  ...
  <tr>
	...
	<td><input type="submit" class="log_in" name="submit" value="Submit"/></td>
