...
?>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
   <tr>
    ...
    <tr>
    <td class="text_black">Address  <span><img src="images/spacer.gif" alt="" width="210" height="1" /></span><span>Required field <span class="red">(*)</span></span></td>
    </tr>
    <tr>
  ...
  <td><select name="title" class="selectbg">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="45%"><input type="text" name="fname" id="fname" value="<?php if(isset($_POST) && $flag ==1){ echo $_POST["fname"];} ?>" class="text_box11" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
        <td width="55%"><input type="text" name="lname" id="lname" value="<?php if(isset($_POST) && $flag ==1){ echo $_POST["lname"];} ?>" class="text_box11" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
      </tr>
      <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><input type="text" name="city" id="city" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["city"];} ?>" class="text_box11" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
        <td><input type="text" name="country" id="country" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["country"];} ?>" class="text_box11" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
      </tr>
    </table></td>
    </tr>
    <tr>
          			...
          			<select name="year" id="year" class="selectbg">
				       <option value="">Year</option>
				        ...
				        for($y = date("Y")-50; $y <= date("Y"); $y++)
				        {
				         ...
				         ?>
                  	</select><a href="#" id="dob" > <img src="images/question.png" align="top" vspace="4" title="GetDeala recomends all users to provide their real date of birth to encourage authenticity and enable us t provide you amazing deals everyday."> </a></td>
 ...
 .tooltip {
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><input type="password" name="password" id="password" class="text_box11" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
          <td><input type="password" name="cpassword" id="cpassword" class="text_box11" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
        </tr>
      </table></td>
    </tr>
    <tr>
        ...
        <td width="39%" align="left" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="2">         
          ...
          <tr>
            <td align="center" valign="top" style="color:#50b6d0; font: bold 18px/18px Arial, Helvetica, sans-serif;">*<br/>
              <br/>*<br/><br/>*<br/><br/>*<br/>
                <br/></td>
            <td align="left" valign="top" style="font: bold 12px/17px Arial, Helvetica, sans-serif; color: #282828;">Your Privacy is assured<br/><br/>
