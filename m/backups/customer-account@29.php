...
<div style="width:700px; float: left; margin: 0 auto;">
	...
	<!-- loop start -->		
			<tr>
				<td>1</td>
				<td>53456SFER</td>
				<td>Click below to print your Deal off<br/><a href="#"><img alt="" src="images/pdf.png" align="top">Your GetDeala deal</a></td>
				<td>Successfull</td>
			</tr>
			<tr>
				<table cellpadding="5" cellspacing="0"  width="100%">
					<tr>
						<td width="30%"><img alt="" src="images/pix7.jpg" align="top" height="150px" width="150px"></td>
						<td width="70%">
							<h4>Deal Information</h4>
							<p>$90.00 for $100.00 at store1 10 % off test description</p>
							<p>Purchase Date: 16th Oct 2011</p>
							<p>Price of Deal: &pound; 18.71</p>
							<p>Quantity: 10</p>
							<p style="font: bold 18px/20px Tahoma, Arial, Helvetica, sans-serif;	color: red; float: right;">Savings: &pound; 28.71</p>
							<p style="font: 11px/20px Tahoma, Arial, Helvetica, sans-serif;	color: red; float: left;">Valid untill 17th November 2011</p>
						</td>
					</tr>
				</table>
			</tr>
	...
	if(strtolower($_SERVER['REQUEST_METHOD']) == 'post' && $_POST["btnNameUpdate"]=='Save Changes')
	{
		...
		if($flag != 1 && $current_password == md5($npassword)) {
     ...
     <table width="450" border="0" align="left" cellpadding="3" cellspacing="3">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><input type="text" name="fname" id="fname" value="<?php if(isset($_POST["btnNameUpdate"])) { echo $_POST["fname"];}else{ echo $fname;} ?>" class="text_box12"/></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>Last name </td>
	...
	if(strtolower($_SERVER['REQUEST_METHOD']) == 'post' && $_POST["btnAddressUpdate"]=='Save Changes')
	{
		...
		if($flag != 1 && $current_password == md5($apassword)) {
  ...
  <table width="450" border="0" align="left" cellpadding="3" cellspacing="3">
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><input type="text" name="city" id="city" value="<?php if(isset($_POST["btnAddressUpdate"])) { echo $_POST["city"];}else{ echo $city;} ?>" class="text_box12"/></td>
                <td>&nbsp;</td>
              </tr>
              ...
              <tr>
                <td><input type="text" name="country" id="country" value="<?php if(isset($_POST["btnAddressUpdate"])) { echo $_POST["country"];}else{ echo $country;} ?>" class="text_box12"/></td>
                <td>&nbsp;</td>
              </tr>
	...
	if(strtolower($_SERVER['REQUEST_METHOD']) == 'post' && $_POST["btnEmailUpdate"]=='Save Changes')
	{
		...
		if($flag != 1 && $current_password == md5($epassword)) {
  ...
  <?php 
	...
	if(strtolower($_SERVER['REQUEST_METHOD']) == 'post' && $_POST["btnPassUpdate"]=='Save Changes')
	{
		...
		if($flag != 1 && $current_password == md5($ppassword)) {
     ...
     <table width="450" border="0" align="left" cellpadding="3" cellspacing="3">
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><input type="password" name="password" id="password" class="text_box12"/></td>
                <td>&nbsp;</td>
              </tr>
              ...
              <tr>
                <td><input type="password" name="rpassword" id="rpassword" class="text_box12"/></td>
                <td>&nbsp;</td>
              </tr>
            </table>
            </td>
...
<div class="clear"></div>
		<?php
		if(strtolower($_SERVER['REQUEST_METHOD']) == 'post' && ($_POST["btnNameUpdate"]=='Save Changes' || $_POST["btnAddressUpdate"]=='Save Changes' || $_POST["btnEmailUpdate"]=='Save Changes' || $_POST["btnPassUpdate"]=='Save Changes')) { 
		?>
			<div style="height: 25px; width: auto; margin: 10px; margin-left: 165px; margin-right: 5px; padding: 5px; border: 1px dashed <?php if ($err_msg != "") {echo "red";} else {echo "green"; } ?>;">
				<?php if($err_msg != "") { ?>
				<label style="color: #CC0000; font-weight: bold; font-family: verdana;"><img src="images/cross.gif" align="middle"><?=$err_msg?></label>
				<?php } ?>
				<?php if($succ_msg != "") { ?>
				<label style="color: #006600; font-weight: bold; font-weight: bold; font-family: verdana;"><img src="images/tick_mark.gif" align="middle"><?=$succ_msg?></label>
				<?php }	?>
			</div>
		<?php } ?>
