...
<?php
	$flag = 0;
	if(strtolower($_SERVER['REQUEST_METHOD']) == 'post' && $_POST['btnLogin'] == "Ask me anything")
	{
		$lemail = $_POST["lemail"];
    ...
    <td class="lb_mid"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="blue_box" style="width:100%; background: none; border: none;">
       <tr>
         ...
         <table width="600" border="0" align="center" cellpadding="3" cellspacing="3">
           ...
           <tr>
             <td width="127"><input type="submit" name="btnLogin" value="Ask me anything" class="reset_btn2" style="cursor:pointer; font-size:20px;" /></td>
...
<?php } else { ?><br />
<span style="padding-left: 22px;"><fb:login-button perms="email" autologoutlink="true">Connect</fb:login-button></span>
<?php } ?>
<br/><br/></td>
	   </tr>
     </table></td>
