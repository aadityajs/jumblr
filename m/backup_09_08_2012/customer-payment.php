				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					?> <td style="color:#7fd7fc; font: normal 12px/18px Arial, Helvetica, sans-serif;" width="59%">
					 ...
					 <?php
					  ...
					  ?>
					 <div style="float: right; text-align:right; width: 130px; margin-top: 3px;"><input type="submit" class="tellbtn13" name="submit" value="Apply" id="discount" /></div>
					 </div>
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
	 ...
	 //  var disc=<?php echo getSettings(discount);?>
	 //  alert(str);
	  /*	document.getElementById("payment_amount").value = xmlhttp.responseText-(xmlhttp.responseText*.20);
	    document.getElementById("total_price").innerHTML='<?php echo getSettings(currency_symbol); ?>'+(xmlhttp.responseText-(xmlhttp.responseText*.20));
	    document.getElementById("big_total_price").innerHTML = '<?php echo getSettings(currency_symbol); ?>'+(xmlhttp.responseText-(xmlhttp.responseText*.20));
	    document.getElementById("frm_paypal_total_price").value=(xmlhttp.responseText-(xmlhttp.responseText*.20));
