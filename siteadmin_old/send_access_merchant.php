...
if(empty($userexists['email'])){
 echo "Account does not exist."; 
	 ...
	 exit;
				...
				$subject = "Your Merchant Account details for PermiumCity.com";
				$txt = "Congratulations!! Your account is created in WakaDeals.com and userid is : ".$userexists['email']."<br /><br /><br />";
