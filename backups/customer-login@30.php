...
<div id="leftcol">
<div class="deal_info">
<div class="green_curv1"></div>
<div class="clear"></div>
<div class="green_curv3">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="blue_box">
       <tr>
         ...
         <table width="600" border="0" align="center" cellpadding="3" cellspacing="3">
             <tr>
             <td colspan="3"><h6>Already have an Account?</h6></td>
           </tr>
           <tr>
             <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr>
                 <td><input type="text" name="lemail" id="lemail" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["lemail"];} ?>"class="text_box1" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
           ...
           <tr>
             <td colspan="3"><a href="#" style="color: blue; font-size:8.5px; font:Times new roman; ">Forgot password</a> </td>
           </tr>
         </table>
...
<h6 style="margin-left: 20px;" >New User Registration</h6>
...
<div style="border:1px #CCCCCC solid;">
  ...
  <td><select name="title" class="selectbg">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="45%"><input type="text" name="fname" id="fname" value="<?php if(isset($_POST) && $flag ==1){ echo $_POST["fname"];} ?>" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
      </tr>
      <tr><td>&nbsp;</td></tr>
      <tr>
      ...
      <tr>
        <td width="55%"><input type="text" name="lname" id="lname" value="<?php if(isset($_POST) && $flag ==1){ echo $_POST["lname"];} ?>" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
      </tr>
       <tr><td>&nbsp;</td></tr>
      <tr>
      ...
      <tr>
        <td colspan="2"><input type="text" name="add1" id="add1" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["add1"];} ?>" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
      </tr>  
       <tr><td>&nbsp;</td></tr>    
    </table></td>
    </tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><input type="text" name="city" id="city" style="width: 210px; margin-right: 10px; <?php if ($flag ==1) {echo 'border:1px solid red;';} ?>" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["city"];} ?>" class="text_box11" /></td>
        <td><input type="text" name="postcode" id="postcode" style="width: 100px; <?php if ($flag ==1) {echo 'border:1px solid red;';} ?>" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["postcode"];} ?>" class="text_box11"/></td>
      </tr>
    </table></td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    ...
    <tr>
      <td><input type="text" name="email" id="email" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["email"];} ?>" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
    ...
    <tr>
      <td><input type="text" name="confemail" id="confemail" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["confemail"];} ?>" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
          			...
          			<select name="year" id="year" class="selectbg">
				       <option value="">Year</option>
				        ...
				        for($y = date("Y")-50; $y <= date("Y"); $y++)
				        {
				         ...
				         ?>
                  	</select><a href="javascript: showDetails(10)" onMouseOver="return overlib('&lt;font class=bodytext&gt;GeeLaza recomends all users to provide their real <br>date of birth to encourage authenticity and enable us <br>to provide you amazing deals everyday.&lt;/font&gt;',VAUTO,CAPTION,'&lt;font class=help&gt;<span align=center>Why should i provide my birthday? </span> &lt;/font&gt;',BORDER,'1');" onMouseOut="nd();"><img src="images/question.png" align="top" vspace="4" ></a></td>
        </tr>
      </table></td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><input type="password" name="password" id="password" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
        </tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
        ...
        <tr>
          <td><input type="password" name="cpassword" id="cpassword" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
        </tr>
      </table></td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="font-family:Arial, Helvetica, sans-serif; font-size:11px; color:#3A3B3D; font-weight:normal;">By registering you agree to the  <a href="#" style="color: blue; font-size:8.5px; font:Times new roman; ">Terms and Conditions</a></span> and  <a href="#" style="color: blue; font-size:8.5px; font:Times new roman; ">Privacy Policy</a></td>
    </tr>
  </table>
   </td>
       </tr>
		...
		<td colspan="2" align="center" valign="middle" style="color:#000; font: bold 14px/18px Calibri, Arial, Helvetica, sans-serif;">&nbsp;</td>
          ...
          <tr>
            ...
            <td align="left" valign="top"><input type="submit" name="btnRegister" value="Let's Do it!" class="reset_btn_big"  style="cursor:pointer;"/></td>
          </tr>
          <tr>
            <td align="left" valign="top">&nbsp;</td>
            <td align="left" valign="top">&nbsp;</td>
