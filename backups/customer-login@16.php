    ...
    <td class="lb_mid"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="blue_box" style="width:100%; background: none; border: none;">
       <tr>
         ...
         <table width="600" border="0" align="center" cellpadding="3" cellspacing="3">
           ...
           <tr>
             <td colspan="3" class="forgot_password"><a href="<?php echo SITE_URL; ?>forgetpassword.php" style="color: blue; font-size:12px; font-family:Arial, Helvetica, sans-serif; ">Forgot your password?</a> </td>
           </tr>
           <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="width:auto;">
                  <tr>
                    <td>
                        ...
                        <?php } else { ?>
                        <span><fb:login-button scope="email" autologoutlink="true">Connect</fb:login-button></span>
                        <?php } ?>
                    </td>
