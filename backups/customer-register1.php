...
if($flag !=0)
{
	...
	{
		?>
		<div style="width:345px; height:35px; background-color:transparent;padding-top:4px; padding-left:30px;">
...
?>
  ...
  <td><select name="title" class="selectbg">
    ...
    <tr>
      ...
      <input type="text" name="email" id="email" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["email"];} ?>" class="text_box12" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/>
      </td>
    </tr>
    <tr><td><img src="images/spacer.gif" alt="" width="1" height="13"/></td></tr>
    <tr>
...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("cust_register");
    ...
    frmvalidator.addValidation("day","dontselect=000","You must confirm your age");
    frmvalidator.addValidation("month","dontselect=000","You must confirm your age");
           ...
           <tr>
             <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr>
                 ...
                 <input type="text" name="lemail" id="lemail" onsubmit="javascript: return validateEmail(this.value);" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["email"];} ?>"class="text_box1" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
                 <td>
