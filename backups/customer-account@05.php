...
<div style="width:700px; float: left; margin: 0 auto;">
    ...
    <div class="TabbedPanels1" id="myaccount_1">
		...
		<table width="100%" height="25px" cellpadding="5" cellspacing="0" style="font: 12px/17px Tahoma, Arial, Helvetica, sans-serif; color: #6b6b6b;">
			<tr class="gray_01">
				...
				<td style="background:#dae8c4;">Status</td>
			</tr>
	<!-- loop start -->		
			<tr class="gray_02">
				<td>1</td>
			...
			<tr>
                ...
                <table cellpadding="0" cellspacing="0"  width="100%" class="deal_decp">
					<tr>
					  <td width="30%" rowspan="5" style="padding: 0 8px 0 8px;"><img alt="" src="images/pix7.jpg" align="top" height="150px" width="150px" /></td>
					  <td colspan="2"><h4>Deal Information</h4></td>
  			</tr>
					<tr>
					  <td colspan="2"><strong>$90.00 for $100.00 at store1 10 % off test description</strong></td>
 			</tr>
					<tr>
					  <td>Purchase Date: 16th Oct 2011</td>
                      <td>Price of Deal: &pound; 18.71</td>
  			</tr>
					<tr>
					  <td style="line-height:20px;">Quantity: 10</td>
                      <td style="font:bold 18px/26px Tahoma, Arial, Helvetica, sans-serif;	color: red; float: right; padding-top:6px;">Savings: &pound; 28.71</td>
  			</tr>
					<tr>
						<td width="70%" colspan="2" style="font: 11px/20px Tahoma, Arial, Helvetica, sans-serif; color: red;">
						Valid untill 17th November 2011				</td>
					</tr>
				</table>
                </td>
			</tr>
	...
	<div class="TabbedPanels1" id="myaccount_2" style="display:none;">
	   <div style="width:100%;">
		...
		--><center><img alt="" src="images/credit_img.gif"></center>
    </div>
    
    <div class="TabbedPanels1" id="myaccount_2_b" style="display:none; margin-top:0px; width:98%;">
  ...
  <table width="450" border="0" align="left" cellpadding="3" cellspacing="3">
	...
	<div class="TabbedPanels1" id="myaccount_4" style="display:none;">
		...
		<table class="myaccount" id="pass">
			<tr>
				<td style="float:left; width: 100px; margin: 0 auto;"><p style="font-family: Helvetica; font-size: 9px; font-weight: bold; color: #000;">Password:</p></td>
				<td style="float:left; width: 170px; margin: 0 auto;"><p style="font-family: Helvetica; font-size: 9px; color: #000;">***************</p></td>
				<td style="float:right; width: 30px; margin: 0 30px;"><p><a onclick="editFields(this); return false;" href="">Edit</a></p></td>
			</tr>
      	</table>
  ...
  <?php 
              ...
              <tr>
                <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="60%">Retype Password </td>
                    </tr>
                    <tr>
	...
	<!--<table class="myaccount" id="noti">
     ...
     --><table class="myaccount" id="noti">
			<tr>
				<td style="float:left; width: 160px; margin: 0 auto;">
                <p style="padding:0px 0;"><img src="images/notification.gif" style="height: 23px; width: 29px;" /></p>
                <p style="padding:0px 0;">I am subscribe to</p></td>
				<td style="float:left; width: 170px; margin: 0 auto;"><p>West London, London</p></td>
				<td style="float:right; width: 30px; margin: 0 30px;"><p><a onclick="editFields(this); return false;" href="">Edit</a></p></td>
			</tr>
     </table>
	...
	<table width="450" border="0" cellspacing="0" cellpadding="0" class="white_box form_box" >
      ...
      <!--<?php
		if(strtolower($_SERVER['REQUEST_METHOD']) == 'post' && $_POST["btnNotiUpdate"]=='Save' ) { 
		?>
			<div style="height: 25px; width: auto; margin: 10px; padding: 5px; border: 1px dashed <?php if ($flag == 1) {echo "red";} else {echo "green"; } ?>;">
				<?php if($flag==1) { ?>
				<label style="color: #CC0000; font-weight: bold;"><?=$msg?></label>
   ...
   <h4 style="border-bottom:2px solid #000;">United Kingdom</h4>
     <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list_box">
      <tr>
        <th><strong>ENGLAND</strong></th>
        <th><strong>Tick all the cities:</strong></th>
        <th><input type="checkbox" name="checkbox" id="checkbox" /><strong>National Deals</strong></th>  
      </tr>
      <tr>
        <td><input type="checkbox" name="checkbox" id="checkbox" />West London,</td>
        <td><input type="checkbox" name="checkbox" id="checkbox" />West London,</td>
        <td><input type="checkbox" name="checkbox" id="checkbox" />West London,</td>  
      </tr>
      <tr>
