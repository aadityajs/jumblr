...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="blue_box" style="width:100%;">
       <tr>
         ...
         <table width="600" border="0" align="center" cellpadding="3" cellspacing="3">
           ...
           <tr>
             <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr>
                 ...
                 <input type="text" name="lemail" id="lemail" value="<?php if(isset($_POST) && $flag==1){ echo $_POST["email"];} ?>"class="text_box1" <?php if ($flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
                 <td>
           ...
           <tr>
             <td colspan="3" class="forgot_password"><a href="<?php echo SITE_URL; ?>forgetpassword.php" style=" font-size:8.5pt; font-weight:normal; font-family:"Times New Roman", Arial, Helvetica, sans-serif;>Forgot password</a> </td>
           </tr>
         </table>
