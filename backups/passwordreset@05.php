...
<form name="reset_password" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="javascript: return Validator();">
	<table width="340" border="0" align="center" cellpadding="0" cellspacing="0" class="password">
	  <tr>
	  ...
	  <tr>
	    ...
	    <input type="password" name="newpassword" id="newpassword" class="white_28" <?php if(isset($_POST) && $flag ==1) {echo 'style="border:1px solid red;"';} ?>/></td>
	  </tr>
	  <tr>
