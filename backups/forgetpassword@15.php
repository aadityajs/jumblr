...
if($flag == 2) {
?>
	<p class="reset" style="padding: 15px;">Please check your email address for a password reset link. We recoment that you check your inbox and junk mail.</p>
...
<table width="600" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
	...
	<td><input type="submit" class="reset_btn" name="submit" value="Submit"/></td>
