...
<div class="today_deal">
	  ...
	  <div style="height: auto;"><a href="#"><h1><?php echo strip_tags($today_res['title']); ?></h1></a></div>
	  <div class="clear"><img src="images/spacer.gif" alt="" width="1" height="1" /></div>
	  <div class="<?php if ($_GET['action'] == "sold") { echo "tab_button1"; } else {echo "tab_button"; } ?>"><span>&pound;<?php echo strip_tags($today_res['discounted_price']); ?></span></div>
	  <div class="deal_left">	  
	  <div class="blue_box">
...
<div class="clear"><img src="images/spacer.gif" alt="" width="1" height="4" /></div>
 ...
 <script language="javascript">
   ...
   <div class="font24px" >
   	<?php if ($_GET['action'] != "sold") { ?>
   		<?php if($total_buy[0] != 0) {echo $total_buy[0].' Bought!';} else {echo "Not Yet Bought!";} ?>
   	<?php } ?>
   		<?php if ($_GET['action'] == "sold") { echo "Deal Completed!";} ?>
   </div>
	<div>
	<ul>
